...
$string['mailinggroups'] = 'Groupes';
$string['mailinggroups_help'] = 'Sélectionnez les groupes souhaités. Si aucun groupe n\'est sélectionné, l\'mail s\'enverra à tous les groupes.';
$string['mailingcohorts'] = 'Cohortes';
$string['mailingcohorts_help'] = 'Sélectionnez les cohortes souhaitées. Si aucune cohortes n\'est sélectionné, l\'mail s\'enverra à toutes les cohortes.';
$string['groupcohortscombination'] = 'Combinaison Groupes/Cohortes';
$string['groupcohortscombination_help'] = 'Si vous sélectionnez à la fois des groupes et des cohortes, l\'email sera envoyé aux utilisateurs appartenant aux groupes sélectionnés, aux cohortes sélectionnées, ou aux deux. Choisissez l\'option appropriée pour spécifier comment combiner ces sélections.';
$string['usermemberofselectedgroupsorselectedcohorts'] = 'Utilisateur membre d\'un groupe sélectionné OU d\'une cohorte sélectionée';
$string['usermemberofselectedgroupsandselectedcohorts'] = 'Utilisateur membre d\'un groupe sélectionné ET d\'une cohorte sélectionée';
...
$string['mailingtimesnumbermax'] = "Nombre de fois: ";