...
$string['mailinggroups'] = 'Groups';
$string['mailingmailingcohorts'] = 'Cohorts';
$string['mailinggroups_help'] = 'Select the groups you want. If no one is selected, the mail will be sent to every groups.';
$string['mailingcohorts'] = 'Cohorts';
$string['mailingcohorts_help'] = 'Select the cohorts you want. If no one is selected, the mail will be sent to every cohorts.';
$string['groupcohortscombination'] = 'Combination Groups/Cohorts';
$string['groupcohortscombination_help'] = 'If you select both groups and cohorts, the email will be sent to users who belong to the selected groups, the selected cohorts, or both. Choose the appropriate option to specify how to combine these selections.';
$string['usermemberofselectedgroupsorselectedcohorts'] = 'User member of a selectec group OR a selected cohort';
$string['usermemberofselectedgroupsandselectedcohorts'] = 'User member of a selectec group AND a selected cohort';
...
$string['mailingtimesnumbermax'] = "Number of times: ";